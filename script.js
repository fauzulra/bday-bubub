...
new TypeIt("#teks1", {
  strings: ["Selamat Ulang tahun Bububku sayang, wish u all the best. semoga diulang tahun ke 20 ini kamu bisa menjadi lebih baik lagi dari sebelumnya dan dikelilingi orang orang baik jugaa:), semogaa makin sayaang sama akuu, makinn bucin samaa akuuu, dan temeninn aku sampee aku suksess aaaamiiiinnnn. ."],
  startDelay: 4000,
  speed: 50,
...
new TypeIt("#teks2", {
  strings: ["Dengan ataupun tanpaku, semoga semesta selalu membahagiakan kamu bagimanapun caranya.",
            " ", 
            "aku sayang kamu. semogaa kitaa bisa bareng barengg selamanyaa yaa.", 
            " ", 
            "Love u so much bub.",  
  ...
  afterComplete: () => {
    setTimeout(() => {
      ...
      document.getElementById("teks2").appendChild(document.createElement("br"));
      document.getElementById("teks2").appendChild(img);
    }, 1000); 
  }
}).go();
